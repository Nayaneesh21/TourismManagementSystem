				...
				<tbody>
						<%try{
							...
							while(rs.next()){
								...
								<td><%=packagecost %></td>
								<%
								Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism","root","1234");
								...
								Connection con2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism","root","1234");
								...
								Connection con3 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism","root","1234");
								...
								Connection con4 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism","root","1234");
